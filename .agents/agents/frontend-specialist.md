...
> **Note:** This agent loads relevant skills (clean-code, frontend-design, lint-and-validate, etc.) for detailed guidance. Apply behavioral principles from those skills rather than copying patterns.
