---
description: description: Coordinate multiple agents for complex tasks. Use for multi-perspective analysis, comprehensive reviews, or tasks requiring different domain expertise.
---
...
| `frontend-specialist` | UI/UX | React, CSS, HTML |
| `backend-specialist` | Server | API, Node.js |
...
### Mode
[Current Codex mode: plan/edit/ask]
